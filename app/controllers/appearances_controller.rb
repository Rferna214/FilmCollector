class AppearancesController < ApplicationController
	# index method gets called when the apearances URL is requested
	...
	def index
		...
		# instance varibale is available to appearances index.html.erb.
		@actors = Actor.all
	...
	# create method gets called wen the Create button is pushed on the 
	...
	def create
		...
		if appearance.save
			...
			# if the save method fails, request the appearance/index URL
			# which will rendor the apperance index.html.erb in the browser
