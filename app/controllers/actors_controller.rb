class ActorsController < ApplicationController
	...
	def create 
		...
		# new.html.erb
		# construct creates Actor model object which is stored
		# in variable
		actor = Actor.new(actor_params)
		# call save method on Actor object
		# save method inserts the data in the Acor model object
		...
		if actor.save
			...
			# if the save method fails, request the actors URL
	...
	#edit methods gets called when the actors/:id/edit URL is requested
	...
	def update
		...
		if actor.update(actor_params)
			...
			# will render the actors infex.html.erb
			redirect_to "/actors"
		else
			...
			flash[:errors] = actor.errors.full_messages
			# requested the actors/:id/edit URL which will render the actors
			# edit.html.erb
